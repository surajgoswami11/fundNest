...
import { FormLabel, Paper, TextField, Typography, Box } from "@mui/material";
        ...
        >
          ...
          <Box sx={formRowStyle}>
            ...
            <Box sx={halfWidthBox}>
              ...
              <FilePond files={userKyc?.passbookImage} credits={false} />
            </Box>
          </Box>
          ...
          <Box sx={formRowStyle}>
            ...
            <Box sx={halfWidthBox}>
              ...
              <FilePond files={userKyc?.aadharImage} credits={false} />
            </Box>
          </Box>
          ...
          <Box sx={formRowStyle}>
            ...
            <Box sx={halfWidthBox}>
              ...
              <FilePond files={userKyc?.panImage} credits={false} disabled />
            </Box>
          </Box>
        </Paper>
      )}
